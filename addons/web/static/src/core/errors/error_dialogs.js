...
ErrorDialog.title = _t("FilesDNA Error");
...
ClientErrorDialog.title = _t("FilesDNA Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _t("FilesDNA Network Error");
...
export class RedirectWarningDialog extends Component {
    setup() {
        ...
        this.title = capitalize(subType) || _t("FilesDNA Warning");
        this.message = message;
...
SessionExpiredDialog.title = _t("FilesDNA Session Expired");
